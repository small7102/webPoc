(function (global) {
	...
	SpeexEncoder.prototype.process = function (pcmdata) {
		var output_offset = 0,
			offset = 0,
			len, nb, err, tm_str, segments = [],
			encode_func = this.floating_point ? libspeex._speex_encode : libspeex._speex_encode_int,
			benchmark = !!this.params.benchmark, // Varies from quality
		...
		this.output = new Int8Array(estimated_size);
		//}
